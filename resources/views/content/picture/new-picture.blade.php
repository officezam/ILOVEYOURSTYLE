      ...
      <div class="col-md-12 col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Picture Send to Indvidual Phone</h4>
          </div>
          <div class="card-body">
              <form class="form form-horizontal" action="{{'save-send-picture'}}" method="post" accept-charset="UTF-8" enctype="multipart/form-data" >
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="form-group row">
                    <div class="col-sm-3 col-form-label">
                      <label for="first-name">Select a Picture Message</label>
                    </div>
                    <div class="col-sm-9">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="picture_link" required accept="image/jpeg/png/jpg">
                ...
                <div class="col-12">
                  <div class="form-group row">
                    <div class="col-sm-3 col-form-label">
                      <label for="email-id">Text with Picture</label>
                    </div>
                    <div class="col-sm-9">
                      <div class="form-label-group mb-0">
                        <p>Write Picture Message here</p>
                        <textarea
                                required
                                data-length="100"
